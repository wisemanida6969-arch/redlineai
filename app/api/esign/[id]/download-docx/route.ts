    ...
    const doc = new Document({
      ...
      sections: [{
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "레드라인AI ", bold: true, size: 36, color: "E53E3E" }),
          ...
          new Paragraph({
            children: [new TextRun({
              text: "This electronic signature was captured using 레드라인AI. The signer agreed that this constitutes a legally binding electronic signature.",
