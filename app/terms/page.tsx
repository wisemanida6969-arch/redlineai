          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-slate-300 leading-relaxed">
            ...
            <div className="bg-yellow-900/15 border border-yellow-700/30 rounded-xl p-4">
              ...
              <p className="text-yellow-200/90 text-sm">
                RedlineAI는 프리랜서 권익 보호를 위해 계약서 내 불공정 조항 위험을 탐지하는 표준 가이드 툴이며,
                변호사의 법률 자문이나 대리를 대체하지 않습니다. AI가 제공하는 모든 결과물은 참고용 정보이며
                법적 효력이 없습니다. 최종 계약 체결 여부와 그에 따른 법적 책임은 전적으로 사용자 본인에게
                있으며, 중요한 계약은 반드시 변호사 등 법률 전문가와 상담 후 결정하시기 바랍니다.
              </p>
            </div>
