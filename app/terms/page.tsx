        ...
        <div className="bg-[#162035] border border-[#1e3050] rounded-2xl p-8">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-slate-300 leading-relaxed">
            ...
            <section>
              ...
              <p>By accessing or using RedlineAI ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
            </section>
            ...
            <section>
              ...
              <p>The Service is provided "as is" without warranties of any kind. We do not guarantee the accuracy, completeness, or reliability of the AI-generated analysis.</p>
            </section>
