...
export const translations = {
  ...
  landing: {
    ...
    planPackageName:  { en: "Pre-sign Package", ko: "사인 전 패키지" },
    planPackageDesc:  { en: "One contract, one payment — everything before you sign", ko: "계약서 1건당 단건 결제" },
    planPackagePer:   { en: "/contract", ko: "/계약서 1건" },
    recommended:      { en: "Recommended", ko: "추천" },
    featPackagePdf:       { en: "Full comparison PDF report", ko: "비교 결과 전체 PDF 리포트" },
    featPackageStandard:  { en: "Verbatim MCST standard article per differing clause", ko: "상이 조항별 표준계약서 원문 첨부" },
    featPackagePrecedent: { en: "Related court precedents included", ko: "관련 판례 정보 포함" },
    featPackageVendor:    { en: "Vendor-risk result included", ko: "리스크 검색 결과 포함" },
    featPackageUnlock:    { en: "Precedent & risk features unlocked (24h)", ko: "판례·리스크 기능 24시간 잠금 해제" },
    ctaPackage:       { en: "Start a review →", ko: "계약서 검토 시작 →" },
    proBanner:        { en: "An agency or a company?", ko: "에이전시·기업이신가요?" },
    proBannerLink:    { en: "Pro plan →", ko: "프로 플랜 →" },
    proName:          { en: "Pro Plan", ko: "프로 플랜" },
    proPlanDesc:      { en: "Full package features for up to 10 contracts a month", ko: "매월 10건까지 패키지 기능 전체 이용" },
    featProQuota:     { en: "10 contracts / month (package features)", ko: "월 10건 패키지 기능 전체 (PDF+판례+리스크)" },
    featProOverage:   { en: "₩9,900 per extra contract", ko: "10건 초과 시 건당 ₩9,900" },
    featProReset:     { en: "Count resets on your billing date", ko: "건수는 매월 결제일 기준 리셋" },
    ctaProPlan:       { en: "Start Pro", ko: "프로 플랜 시작" },
